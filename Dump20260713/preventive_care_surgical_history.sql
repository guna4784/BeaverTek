...
CREATE TABLE `surgical_history` (
  ...
  `body_part_system` varchar(255) DEFAULT NULL,
  `hospital_name` varchar(255) DEFAULT NULL,
  `has_complication` tinyint(1) DEFAULT NULL,
  ...
  KEY `ix_surgical_history_id` (`id`),
  KEY `ix_surgical_history_patient_id` (`patient_id`),
  CONSTRAINT `surgical_history_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
