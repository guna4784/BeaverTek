...
CREATE TABLE `appointment_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_appointment_type_name` (`appointmentName`),
  KEY `ix_appointment_type_id` (`id`)
...
INSERT INTO `appointment_type` VALUES (1,'General Checkup','Basic health checkup','2026-04-11 10:30:28',NULL,NULL,NULL,0),(2,'Dental','Teeth related consultation','2026-04-11 10:30:28',NULL,NULL,NULL,0),(3,'Cardiology','Heart specialist visit','2026-04-11 10:30:28',NULL,NULL,NULL,0);
